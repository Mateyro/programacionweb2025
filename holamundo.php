<?php echo "Hola Mundo!";//echo test or smthn idk im bored and just typing stuff cuz it feels useful but it isnt hi :P ?> 
<?php $edad = 18; // Enteros, Int ?>
<?php $nombre = 'Manolo'; // Texto, String ?>
...
<?php $Edad = 25;
// La edad de una persona, su edad es 25. Probablemente se use en algun tipo de database.?>

<?php $estAltura = 1.75;
// "est" no tiene una descripcion exacta pero probablemente sea "estimada" completando la palabra para que sea "Altura estimada", en cualquier caso y lo que signifique 
// es una altura de un tipo conectada al nombre de algo, juzgando por el resto de las variables, una persona. ?>
